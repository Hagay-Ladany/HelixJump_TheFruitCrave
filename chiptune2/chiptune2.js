...
var ChiptuneJsPlayer = function (config) {
  ...
  // Create gain node for music volume control (lower volume)
  this.musicGain = this.context.createGain();
  this.musicGain.gain.value = 0.15; // Lower music volume (15%)
...
ChiptuneJsPlayer.prototype.play = function(buffer) {
  ...
  processNode.connect(this.musicGain); // Connect through gain node for volume control
}
